...
import EligibilityProfileForm from './components/EligibilityProfileForm';
...
function App() {
  ...
  const [activeTab, setActiveTab] = useState('browse'); // 'upload', 'browse', 'ask', or 'eligibility'
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
          ...
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              ...
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === 'eligibility'
                  ? 'border-blue-600 text-blue-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }`}
              >
        ...
        <div className="mb-8">
          ...
          {activeTab === 'eligibility' && <EligibilityProfileForm />}
        </div>
